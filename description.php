...
<body>
	...
	<form method="POST" action="inser.php">
        ...
        <div class="form-group">
            <label for="exampleFormControlTextarea1" class="biographie" style="left: -60.4px;">Votre biographie</label>
            <input disabled   maxlength="3" size="3" value="160" id="counter" style="right: 0px;padding-right: 0px;margin-right: 38px;">
